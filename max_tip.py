...
• The third line contains N integers. The ith integer represents Ai. • The fourth line contains N integers. The ith integer represents Bi. Output:
...
def max_tip(a,m,n):
    ...
    for i in range(len(m)):
        if m[i]>n[i]:
            ...
            sum+=n[i]
    return sum
print(max_tip(5,[1,2,3,4,5],[5,4,3,2,1]))
